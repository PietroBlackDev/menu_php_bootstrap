...
//  echo "id: " . $row["coment"]. " - Name: " . $row["poi"]. " " . $row["data"]. "<br>";
//}
...
<header>
      <nav class="navbar fixed-top navbar-dark bg-dark fixed-top">
        <div class="container-fluid">
          <a class="navbar-brand" href="#"><h3>Bem vindo ao Painel <?php echo $_SESSION['nome']; ?></h3></a>
...
<div class="row text-start col-12">
  ...
  <?php while($row = $comentarios->fetch_assoc()) { ?>
    <div class="card">
    <div class="row">
    <div class="coment_nome col-6"> <?php echo $row["name"] ?></div> <div class="col-6 text-end coment_nome"><small"> <?php echo $row["data"] ?> </small></div>
    </div>
  ...
  <?php } ?>
    ...
    <form class="tabela_coment col-8 position" action="" method="POST">
        ...
        <textarea class="col-12"  id="w3review" name="coment" rows="4" cols="50" placeholder="Escreva aqui!" required></textarea><br><br>
